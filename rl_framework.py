...
class FNAgent():
    ...
    def show_state(self, env, episode=0, step=0,episode_reward=0,info=""):
        plt.figure(3)
        plt.clf()
        plt.title("Episode: %d Step: %d Episode Reward: %d %s" % (episode, step, episode_reward, info))
        plt.axis('off')
    ...
    def play(self, env, episode_count=5, render=True, notebook=False):
